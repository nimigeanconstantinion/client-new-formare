...
import {Cursant} from "../../models/Cursant";
import GridPerioadaSomaj from "../GridPeriodaSomaj/GridPerioadaSomaj"
import {WrapperDivDetalii} from "./indexstyle";
interface CursantProps{
    crtCursant:Cursant|undefined
}


 const Index:React.FC<CursantProps>=({crtCursant})=>{
    useEffect(()=>{
        console.log("Detalii cursant")
        console.log(crtCursant);
    },[crtCursant])
    ...
    // )
     ...
     return(
         <WrapperDivDetalii>
             {/*<div className={"p_fld div_nrcontr"}>*/}
             {/*    <label className={"lblCi"} htmlFor={"c_nrcontr"}>Numar Contract</label>*/}

             {/*    <input  type={"text"} className={"search nrcontr"} id={"c_nrcontr"} defaultValue={crtCursant?.nrContract} />*/}

             {/*</div>*/}
             {
                 crtCursant?(
                     <>
                         <GridPerioadaSomaj data={crtCursant.perioadaSomajList}/>
                     </>
